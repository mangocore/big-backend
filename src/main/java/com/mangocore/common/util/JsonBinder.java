...
//                SerializerFeature.MapSortField//Map的序列化后排序再输出
    ...
    public static String toJSONString(Object object) {
        try {
            return StringUtils.trimToEmpty(JSON.toJSONString(object, SerializerFeature.WriteMapNullValue, SerializerFeature.WriteNullListAsEmpty, SerializerFeature.WriteNullStringAsEmpty));
        } catch (Exception e) {
